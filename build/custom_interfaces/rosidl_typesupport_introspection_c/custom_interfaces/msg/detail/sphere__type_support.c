...
#include <stddef.h>
#include "custom_interfaces/msg/detail/sphere__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  custom_interfaces__msg__Sphere__init(message_memory);
}

void Sphere__rosidl_typesupport_introspection_c__Sphere_fini_function(void * message_memory)
{
  custom_interfaces__msg__Sphere__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Sphere__rosidl_typesupport_introspection_c__Sphere_message_member_array[2] = {
  {
    ...
    offsetof(custom_interfaces__msg__Sphere, center),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__msg__Sphere, radius),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Sphere__rosidl_typesupport_introspection_c__Sphere_message_members = {
  ...
  "Sphere",  // message name
  2,  // number of fields
  sizeof(custom_interfaces__msg__Sphere),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, msg, Sphere)() {
